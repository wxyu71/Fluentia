...
public static class LocalizationService
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        ["DebugLoggingBody"] = "Write detailed input synchronization logs to a file. Useful for diagnosing text input issues. Logs are saved to %APPDATA%\\Fluentia\\logs\\debug.log",
        ...
        ["TrayNotificationPortableUpdateBody"] = "Portable version. Download Setup.exe for auto-update.",
    };
    ...
    private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>
    {
        ...
        ["CloseBehaviorBody"] = "关闭时隐藏到通知区。",
        ["StartupTitle"] = "随 Windows 启动",
        ["StartupBody"] = "登录时自动启动。",
        ["DebugLoggingTitle"] = "调试日志",
        ["DebugLoggingBody"] = "将详细的输入同步日志写入文件，用于排查文字输入问题。日志保存在 %APPDATA%\\Fluentia\\logs\\debug.log",
        ["ReceivedFilesTitle"] = "接收文件",
        ["ReceivedFilesBody"] = "接收文件保存位置。",
        ["ButtonBrowse"] = "浏览",
        ...
        ["SettingsLanguageBody"] = "显示语言。",
        ["LanguageSystem"] = "跟随系统",
        ["LanguageEnglish"] = "英语",
        ["LanguageChinese"] = "简体中文",
        ["SettingsSessionTitle"] = "配对会话",
        ["SettingsSessionBody"] = "仅在需要轮换密钥时创建。",
        ["ConnectionHintNoNetwork"] = "请先让这台电脑重新联网，再生成配对会话。",
        ["ConnectionHintTrustedWaiting"] = "等待已信任手机重连。",
        ["ConnectionHintEncrypted"] = "已配对，就绪。",
        ["ConnectionHintSessionReady"] = "会话就绪，有效 {0} 天。",
        ["ConnectionHintConnectedPreparing"] = "已连接，准备会话中。",
        ["ConnectionHintConnectToRelay"] = "连接中继服务器。",
        ["PairingNoticeNetworkTitle"] = "网络已断开",
        ["PairingNoticeNetworkBody"] = "重新联网以显示 QR 或码。",
        ["PairingNoticeServerTitle"] = "服务器未连接",
        ["PairingNoticeServerBody"] = "连接中继以配对。",
        ["PairingNoticePreparingTitle"] = "正在准备会话",
        ["PairingNoticePreparingBody"] = "正在创建会话...",
        ["PairingNoticeExpiredTitle"] = "会话已过期",
        ["PairingNoticeExpiredBody"] = "请创建新会话。",
        ["PairingNoticeWaitingReconnectTitle"] = "等待重新连接",
        ["PairingNoticeWaitingReconnectBody"] = "保留已保存会话——自动重连。",
        ["PairingNoticeReadyTitle"] = "安全通道已就绪",
        ["PairingNoticeReadyBody"] = "已连接。密钥轮换前隐藏控件。",
        ["PairingNoticeSecuringTitle"] = "正在建立安全连接",
        ["PairingNoticeSecuringBody"] = "正在完成密钥交换...",
        ...
        ["TrayNotificationInputTargetBody"] = "请将目标应用切到前台以继续输入。",
        ["TrayNotificationInputTargetBodyInvalid"] = "之前的窗口已失效，请切换到新应用。",
        ...
        ["StatusUpdateNotInstalled"] = "请安装 Fluentia-Setup.exe 以启用自动更新。",
        ["StatusUpdateCheckFailed"] = "检查更新失败：{0}",
        ["StatusUpdateApplied"] = "更新已应用 — 正在重启...",
        ["TrayNotificationPortableUpdateTitle"] = "自动更新不可用",
        ["TrayNotificationPortableUpdateBody"] = "便携版无法自动更新，请下载 Setup.exe。",
    };
